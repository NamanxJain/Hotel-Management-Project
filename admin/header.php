                ...
                <li class="dropdown"><a class="dropdown-toggle count-info" data-toggle="dropdown" href="#">
                    ...
                    <ul class="dropdown-menu dropdown-alerts">
                        <li><a href="logout.php"><i class="fa fa-power-off" style="color:red;"></i>
                            ...
                            <li><a href="registration.php"><i class="fa fa-user" style="color:orange;"></i>
                                registration 
                            </a></li>
                            <li><a href="update.php?id=<?php echo $_SESSION['user_id']; ?>"><i class="fa fa-user" style="color:green;"></i>
                                update 
                            </a></li>
                    </ul>
                </li>
